...
func (suite *IntegrationSuite) Test_aged_debt() {
	...
	_, c1i1Ref := suite.seeder.CreateInvoice(ctx, client1ID, fh.InvoiceTypeAD, nil, twoMonthsAgo.StringPtr(), nil, nil, nil)
	paidInvoiceID, _ := suite.seeder.CreateInvoice(ctx, client1ID, fh.InvoiceTypeAD, nil, twoMonthsAgo.StringPtr(), nil, nil, nil)
	...
	_, c2i1Ref := suite.seeder.CreateInvoice(ctx, client2ID, fh.InvoiceTypeAD, nil, fourYearsAgo.StringPtr(), nil, nil, nil)
	_, c2i2Ref := suite.seeder.CreateInvoice(ctx, client2ID, fh.InvoiceTypeS2, &general, twoYearsAgo.StringPtr(), twoYearsAgo.StringPtr(), nil, nil)

	// excluded clients as out of range
	client3ID := suite.seeder.CreateClient(ctx, "Too", "Early", "99999999", "9999")
	suite.seeder.CreateInvoice(ctx, client3ID, fh.InvoiceTypeAD, nil, sixYearsAgo.StringPtr(), nil, nil, nil)
	client4ID := suite.seeder.CreateClient(ctx, "Too", "Early", "99999999", "9999")
	suite.seeder.CreateInvoice(ctx, client4ID, fh.InvoiceTypeAD, nil, today.StringPtr(), nil, nil, nil)
