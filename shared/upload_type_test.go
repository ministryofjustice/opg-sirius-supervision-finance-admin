...
func TestReportUploadType_Filename(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			dateString:   "2020-01-02",
			wantErr:      false,
			wantFilename: "feemoto_02012020normal.csv",
		},
		{
			...
			wantErr:      false,
			wantFilename: "feemoto_03122024mlpayments.csv",
		},
		{
			...
			wantErr:      false,
			wantFilename: "feebacs_01102024_new_acc.csv",
		},
		{
			...
			wantErr:      false,
			wantFilename: "feebacs_21112024.csv",
		},
		{
			name:         "Invalid date",
			uploadType:   ReportTypeUploadPaymentsMOTOCard,
